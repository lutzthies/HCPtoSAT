...
int main( int argc, char* argv[] )
{
        ...
        condition1(&out1, ref(edge_matrix), &c1, vertices_count);
        condition2(&out2, ref(edge_matrix), vertices_count, &c2);
        condition3(&out3, ref(edge_matrix), &c3, vertices_count);
        condition4(&out4, ref(edge_matrix), &c4, vertices_count);
        condition5(&out5, &c5, vertices_count);
        //thread t6(condition6, &out6, &c6, vertices_count);
        condition7(&out7, &c7, vertices_count);
        condition8(&out8, &c8, vertices_count);
        condition9(&out9, &c9, vertices_count);
        condition10(&out10, &c10, vertices_count);
        condition11(&out11, &c11, vertices_count);
